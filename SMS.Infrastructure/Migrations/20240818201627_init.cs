        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    breakStart = table.Column<int>(type: "int", nullable: false),
                    breakEnd = table.Column<int>(type: "int", nullable: false),
                    breakRange = table.Column<int>(type: "int", nullable: false),
                    SeanceDuration = table.Column<int>(type: "int", nullable: false),
                    firstSeanceStart = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
